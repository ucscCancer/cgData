...
skipFiles =  ["MANIFEST.txt","CHANGES_DCC.txt","README_DCC.txt","DESCRIPTION.txt", "README_HIPAA_AGES",
			...
			if path.endswith( '.sdrf.txt' ):
				...
				for row in read:
					if colNum is None:
						...
						if not colNum.has_key("Material Type") or row[ colNum[ "Material Type" ] ] != "genomic_DNA":
